...
0.0, 0.0, 0.0, 0.0),
color: FFAppState().chatTab == 'Berichten'
...
elevation: 0.0,
hoverColor: FFAppState().chatTab == 'Berichten'
? FlutterFlowTheme.of(context).primary
: FlutterFlowTheme.of(context)
.primary
...
child: FFButtonWidget(
onPressed: () async {
FFAppState().chatTab = 'Community chat';
safeSetState(() {});
},
text: 'Community chat',
options: FFButtonOptions(
...
iconPadding: EdgeInsetsDirectional.fromSTEB(
0.0, 0.0, 0.0, 0.0),
color: FFAppState().chatTab == 'Community chat'
? FlutterFlowTheme.of(context).primary
: FlutterFlowTheme.of(context).alternate,
textStyle: FlutterFlowTheme.of(context)
.titleSmall
...
iconPadding: EdgeInsetsDirectional.fromSTEB(
0.0, 0.0, 0.0, 0.0),
color: FFAppState().chatTab == 'Groeps chat'
? FlutterFlowTheme.of(context).primary
: FlutterFlowTheme.of(context).alternate,
textStyle: FlutterFlowTheme.of(context)
.titleSmall
...
elevation: 0.0,
hoverColor: FFAppState().chatTab == 'Groeps chat'
? FlutterFlowTheme.of(context).primary
: FlutterFlowTheme.of(context)
.primary
.withValues(alpha: 0.1),
...
final otherUser = chat.userid.firstWhere((ref) => ref != currentUserReference);
...
List<ChatsRecord> columnChatsRecordList = uniqueChats.values.toList();
...
filteredChats.length, (columnIndex) {
...
try {
await columnChatsRecord.reference.delete();
          ...
          Padding(
            ...
            child: StreamBuilder<List<GroupsRecord>>(
              ...
              builder: (context, snapshot) {
                ...
                final visibleGroups = filteredGroups
                    .where((g) {
                      final name = g.groupName.trim().toLowerCase().replaceAll('!', '');
                      final last = g.lastmessage.trim().toLowerCase().replaceAll('!', '');
                                      ...
                                      children: [
                                        Row(
                                          ...
                                          children: [
                                            ...
                                            if (g.adminId == currentUserReference)
                                              Container(
                                            ...
                                            children: [
                                              ...
                                              if (g.timestamp != null)
                                                Padding(
                                                  ...
                                                  child: Text(
                                                    '• ${dateTimeFormat("relative", g.timestamp)}',
                                                    style: FlutterFlowTheme.of(context).bodySmall.override(
                                                          font: GoogleFonts.inter(
                                                            fontWeight: FlutterFlowTheme.of(context).bodySmall.fontWeight,
                                                            fontStyle: FlutterFlowTheme.of(context).bodySmall.fontStyle,
...
setState(() {
_model.containerPositionX = details.offset.dx;
_model.containerPositionY = details.offset.dy;
});
},
child: Container(
width: MediaQuery.of(context).size.width - 40,
