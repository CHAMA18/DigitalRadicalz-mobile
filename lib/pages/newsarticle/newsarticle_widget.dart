...
import 'newsarticle_model.dart';
export 'newsarticle_model.dart';
...
class NewsarticleWidget extends StatefulWidget {
  ...
  static String routeName = 'Newsarticle';
  static String routePath = '/newsarticle';
                          ...
                          children: [
                            ...
                            Align(
                              ...
                              child: Stack(
                                children: [
                                  Align(
                                    alignment: AlignmentDirectional(-0.9, 1.04),
                                    child: Container(
                                      width: double.infinity,
                                      height: 87.6,
                                      decoration: BoxDecoration(
                            ...
                            builder: (context, snapshot) {
                              ...
                              return Column(
                                ...
                                children: List.generate(
                                    columnNewsRecordList.length, (columnIndex) {
