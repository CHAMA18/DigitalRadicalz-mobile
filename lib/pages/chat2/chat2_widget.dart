                ...
                children: [
                      ...
                      builder: (context, snapshot) {
                        ...
                        return ListView.builder(
                          ...
                          itemBuilder: (context, listViewIndex) {
                            ...
                            return Stack(
                              children: [
                                (listViewChatmessagesRecord.uidofsender == currentUserReference)
                                    ? Align(
                                        alignment: AlignmentDirectional(0.0, 0.0),
                                        child: Padding(
                                          padding: EdgeInsetsDirectional.fromSTEB(12.0, 0.0, 12.0, 18.0),
                                          child: Row(
                                            mainAxisSize: MainAxisSize.max,
                                            ...
                                            child: Container(
                                              ...
                                              child: Column(
                                                ...
                                                children: [
                                                  ...
                                                  if (listViewChatmessagesRecord.hasVoice() && listViewChatmessagesRecord.voice.isNotEmpty)
                                                    Padding(
                                                      padding:
                                                          EdgeInsetsDirectional
                                                              .fromSTEB(0.0, 0.0,
                  ...
                  Container(
                    ...
                    child: Column(
                      mainAxisSize: MainAxisSize.max,
                      children: [
                        if (_model.uploadedFileUrls_uploadDataHbj1.length != 0)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                12.0, 12.0, 12.0, 12.0),
                            child: Builder(
                              builder: (context) {
                                final images = _model
                                    .uploadedFileUrls_uploadDataHbj1
                                    .toList();
                        ...
                        if (_model.uploadedFileUrl_uploadDataUue11.isNotEmpty)
                          Padding(
                            padding: EdgeInsetsDirectional.fromSTEB(
                                12.0, 0.0, 12.0, 0.0),
                            child: Column(
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (selectedMedia != null &&
                                    ...
                                    safeSetState(() => _model
                                        .isDataUploading_uploadDataHbj1 = true);
                                    ...
                                    try {
                                      ...
                                      ScaffoldMessenger.of(context)
                                          .hideCurrentSnackBar();
                                      _model.isDataUploading_uploadDataHbj1 =
                                          false;
                                    }
                                    if (selectedUploadedFiles.length ==
                                        ...
                                        downloadUrls.length ==
                                            selectedMedia.length) {
                                      safeSetState(() {
                                        _model.uploadedLocalFiles_uploadDataHbj1 =
                                            selectedUploadedFiles;
                                        _model.uploadedFileUrls_uploadDataHbj1 =
                                            downloadUrls;
                                      });
                              ...
                              FlutterFlowIconButton(
                                ...
                                onPressed: () async {
                                  ...
                                  if (selectedFiles != null) {
                                    safeSetState(() =>
                                        _model.isDataUploading_uploadDataUue11 = true);
                                    var selectedUploadedFiles =
                                        <FFUploadedFile>[];
                                      ...
                                      return FlutterFlowIconButton(
                                        ...
                                        : () async {
                                            ...
                                            safeSetState(() {
                                              ...
                                              // Clear any selected attachments after sending
                                              _model.uploadedFileUrls_uploadDataHbj1 = [];
                                              _model.uploadedFileUrl_uploadDataUue11 = '';
                                            });
                                          },
