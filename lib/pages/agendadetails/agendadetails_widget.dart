...
class _AgendadetailsWidgetState extends State<AgendadetailsWidget>
  ...
  double _panelFraction = 0.35; // current height as fraction of screen height
      ...
      builder: (context, snapshot) {
        ...
        return GestureDetector(
          ...
          child: Scaffold(
            key: scaffoldKey,
            backgroundColor: FlutterFlowTheme.of(context).primaryBackground,
            body: StreamBuilder<TicketTypesRecord>(
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: FFButtonWidget(
                                  ...
                                  text: (stackTicketTypesRecord.price ?? 0) == 0 ? 'Register' : 'Get tickets',
                    ...
                    Align(
                      ...
                      child: Padding(
                        padding: EdgeInsets.only(
                          bottom: max(MediaQuery.viewPaddingOf(context).bottom, 12.0),
                        ),
